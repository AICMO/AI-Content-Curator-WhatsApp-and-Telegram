...
def cmd_post(draft_only: bool = False, start_date: str = None, end_date: str = None):
...
def main():
    ...
    cmd_post(draft_only=args.draft, start_date=args.start_date, end_date=args.end_date)
